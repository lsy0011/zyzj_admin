<template>
    <Row :gutter="24">
        ...
        <Card :bordered="false" dis-hover :padding="12">
            <template #title><span>残疾人用户访问量</span></template>
            <template #extra>
                <Tag color="green">昨日</Tag>
                <Tag color="red">上周</Tag>
                <Tag color="blue">上月</Tag>
            </template>
            <div>
        ...
        <Col v-bind="grid" class="ivu-mb">
        <Card :bordered="false" dis-hover :padding="12">
            <template #title><span>爱心用户访问量</span></template>
            <template #extra>
                <Tag color="green">昨日</Tag>
                <Tag color="red">上周</Tag>
                <Tag color="blue">上月</Tag>
            ...
            <div>
                <Numeral value="17943" format="0,0" v-font="30" />
                <div class="ivu-pt-8" v-height="42">
                    <span v-display="'inline-block'" class="ivu-mr">
                        日同比 <Trend flag="up">12.5%</Trend>
                    </span>
                ...
                <div>
                    <Row>
                        <Col span="12">总访问量</Col>
                        <Col span="12" class="ivu-text-right">200 万</Col>
                    </Row>
                </div>
            </div>
        </Card>
        ...
        <Col v-bind="grid" class="ivu-mb">
        <Card :bordered="false" dis-hover :padding="12">
            <template #title><span>残疾人用户注册量</span></template>
            <template #extra>
                <Tag color="green">昨日</Tag>
                <Tag color="red">上周</Tag>
                <Tag color="blue">上月</Tag>
            ...
            <div>
                <Numeral value="35475" format="0,0" v-font="30" />
                <div class="ivu-pt-8" v-height="42">
                    <span v-display="'inline-block'" class="ivu-mr">
                        日同比 <Trend flag="up">12.5%</Trend>
                    </span>
                ...
                <div>
                    <Row>
                        <Col span="12">总访问量</Col>
                        <Col span="12" class="ivu-text-right">390 万</Col>
                    </Row>
                </div>
            </div>
        </Card>
        ...
        <Col v-bind="grid" class="ivu-mb">
        <Card :bordered="false" dis-hover :padding="12">
            <template #title><span>爱心用户注册量</span></template>
            <template #extra>
                <Tag color="green">昨日</Tag>
                <Tag color="red">上周</Tag>
                <Tag color="blue">上月</Tag>
            ...
            <div>
                <Numeral value="26648" format="0,0" v-font="30" />
                <div class="ivu-pt-8" v-height="42">
                    <span v-display="'inline-block'" class="ivu-mr">
                        日同比 <Trend flag="up">12.5%</Trend>
                    </span>
                ...
                <div>
                    <Row>
                        <Col span="12">总访问量</Col>
                        <Col span="12" class="ivu-text-right">210 万</Col>
                    </Row>
                </div>
            </div>
        </Card>
    ...
    <Row :gutter="24">
        ...
        <Card :bordered="false" dis-hover :padding="12">
            ...
            <div>
                <Numeral value="11600" format="0,0" prefix="¥" v-font="30" />
                <div class="ivu-pt-8" v-height="42">
        ...
        <Card :bordered="false" dis-hover :padding="12">
            ...
            <div>
                <Numeral value="128" format="0,0" v-font="30">
                    <template #suffix><span v-font="24"> 位</span></template>
                </Numeral>
                <div class="ivu-pt-8" v-height="42">
