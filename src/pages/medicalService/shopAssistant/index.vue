<template>
    <div class='shopAssistant'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="医疗服务管理" content="商家用户管理" hidden-breadcrumb />
        </div>
        <div class="shopAssistant_main">
            <div class="search_top">
                <Space size="large" wrap>
                    <Space>
                        <strong>机构</strong>
                        <Select v-model="search.merchantId" placeholder="请选择机构" size="small" style="width:160px;">
                    ...
                    <Space>
                        ...
                        <Button size="small"
                            @click="pageNumber = 1; search = { merchantId: '644659b1b0e0c924517c6827' }, getStaffPage()">重置</Button>
                    </Space>
                </Space>
            </div>
            ...
            <Table border :columns="columns" :data="data" @on-selection-change="selectAll" :loading="loading">
                <template #action="{ row }">
                    ...
                    <Button size="small" style="margin: 10px 0 0;">重置密码</Button> -->
                </template>
            </Table>
        ...
        <!-- 增加/编辑的弹框 -->
        <Modal class-name="vertical-center-modal" v-model="flag" :title="modalTitle">
            ...
            <template #footer>
                <Button type="primary" @click="saveConfirmFn('addform')"> 确认 </Button>
...
export default {
    ...
    data() {
        return {
            ...
            baseList: [],  // 机构列表
            storeList: [], // 门店列表
            search: { merchantId: '644659b1b0e0c924517c6827' },  // 搜索
