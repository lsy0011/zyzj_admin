<template>
    <div class='sizeAttribute'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="医药保健商品管理" content="规格属性管理" hidden-breadcrumb />
        </div>
        <div class="sizeAttribute-main">
            ...
            <div class="attri-main-modle">
                <Space size="large" style="margin-bottom: 15px;">
                    ...
                    <Space>
                        <Button type="primary" size="small" @click="detailsSizeFn(false)">增加</Button>
                    </Space>
                </Space>
                <Table border :columns="columns" :data="data">
                    ...
                    <template #actionSlot="{ row }">
                        <Button type="primary" size="small" style="margin-right: 5px"
                            @click="detailsSizeFn(row)">编辑</Button>
...
export default {
    name: 'healthCareGoods-sizeAttribute',
    data() {
        return {
            columns: [
                {
    ...
    created() {
        getGoodsCategoryTreeApi({ biz: 'medical' })
            .then((res) => {
