<template>
    <div class='shopAssistant'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="药品供应商管理" content="商家用户管理" hidden-breadcrumb />
        </div>
        <div class="shopAssistant_main">
            <div class="search_top">
                <Space size="large">
                    <Space>
                        <strong>机构</strong>
                        <Select v-model="search.merchantId" placeholder="请选择机构" size="small" style="width:220px;">
                    ...
                    <Space>
                        <strong>门店</strong>
                        <Select v-model="search.consume" placeholder="请选择门店" clearable size="small"
                            style="width:160px;; ">
                    ...
                    <Space>
                        ...
                        <Button size="small" @click="pageNumber = 1; search = {}, getStaffPage()">重置</Button>
                    </Space>
                </Space>
            </div>
            <Space size="large" style="margin-bottom: 15px;">
                ...
                <Button type="primary" size="small" @click="addStaffFn(false, 'listName')">添加</Button>
            </Space>
            <Table border :columns="columns" :data="data" @on-selection-change="selectAll" :loading="loading">
                <template #action="{ row }">
                    ...
                    <Button type="primary" size="small" style="margin-right: 10px;"
                        @click="addStaffFn(row.id, 'listName')">编辑</Button>
...
export default {
    ...
    data() {
        return {
            ...
            search: {
                merchantId: '64b006fe089e8c0c6f0d5c96',  // 机构id
            },
    ...
    methods: {
        ...
        // 机构列表
        getBaseList() {
            getMerchantBasePageApi({ biz: 'medical', type: 'supplier' }).then(res => {
                let data = res.data
                data.forEach(item => {
