<template>
    <div class='sizeProperty'>
        <!-- <h5>拍品规格属性管理</h5> -->
        <div class="i-layout-page-header">
            <PageHeader title="益助拍管理" content="规格属性管理" hidden-breadcrumb />
        </div>
        <div class="sizeAttribute-main">
            <div class="attri-main-top">
                <Space size="large">
                    ...
                    <Space>
                        <strong>分类</strong>
                        <TreeSelect v-model="search.categoryId" size="small" :data="categoryTree" v-width="120" transfer />
                    </Space>
                    <Space v-if="false">
                        <strong>状态</strong>
                        <Select v-model="search.status" size="small" placeholder="请选择">
            ...
            <div class="attri-main-modle">
                <Space size="large" style="margin-bottom: 15px;">
                    ...
                    <Space>
                        <Button type="primary" size="small" @click="detailsPropFn(false)">增加</Button>
                    </Space>
                </Space>
                <Table border :columns="columns" :data="data">
                    ...
                    <template #action="{ row }">
                        <Button type="primary" size="small" style="margin-right: 5px"
                            @click="detailsPropFn(row)">编辑</Button>
                        <Poptip confirm transfer title="您确认删除吗?" @on-ok="removePropFn(row)">
        ...
        <Modal class-name="vertical-center-modal" v-model="modal" :title="modalTitle">
            <Form ref="listFrom" :model="list" :rules="ruleValidate" :label-width="120">
                ...
                <FormItem label="排序：" prop="rank">
                    <Input v-model="list.rank" placeholder="请输入" type="number"></Input>
                </FormItem>
        ...
        return {
            ...
            ruleValidate: {
                ...
                rank: [
                    ...
                    { required: true, message: '请输入数字序值', trigger: 'blur' },
                ],
                categoryId: [
