<template>
    <div class='orderManage'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="关爱服务管理" content="订单管理" hidden-breadcrumb />
        </div>
                ...
                <Space size="large">
                    ...
                    <Space>
                        <Button type="primary" size="small" @click=" pageNumber = 1; pageSize = 10; getOrderList();">
                            查询</Button>
                        <Button size="small"
                            @click="search = {}; pageNumber = 1; pageSize = 10; getOrderList(), classBtn = 0">重置</Button>
                    </Space>
                </Space>
            </div>
                ...
                <div style="display: flex; justify-content: space-between;">
                    <Space size="large" wrap>
                        ...
                        <Button :class="{ 'btn_border': classBtn == 0 }" size="small"
                            @click=" pageNumber = 1; pageSize = 10; classBtn = 0; search.status = ''; getOrderList();">全部</Button>
                        <Button :class="{ 'btn_border': classBtn == item.id }" size="small" v-for="item in orderStatus"
                            :key="item.code"
                            @click="pageNumber = 1; pageSize = 10; classBtn = item.id; search.status = item.code; getOrderList();">
                            {{ item.name }}
                        </Button>
                    </Space>
                    <Button type="success" size="small" style=" " @click="this.$Message.info('开发中')">导出</Button>
                </div>
            </div>
            ...
            <div class="modal_main">
                ...
                <div v-for="(item, index) in list.items" :key="item.id" style="border: #ddd dashed 1px;">
                    <Row style="margin-bottom: 10px;">
                        ...
                        <span v-color="(item.wo ? '#129646' : '#ee0324')">{{ item.wo ? '已核销' : '未核销' }}</span>
                        </Col>
                    </Row>
                    <Row style="margin-bottom: 10px;">
                        <Col span="2">
        ...
        return {
            ...
            columns: [
                ...
                // },
                {
                    ...
                    align: "center",
                    // render: (h, params) => {
                    //     return h('div', params.row.totalPrice)
                    // }
                },
                {
                    title: '用户手机号',
