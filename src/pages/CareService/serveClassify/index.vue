<template>
    <div class='serveClassify'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="关爱服务管理" content="服务分类管理" hidden-breadcrumb />
        </div>
        <div class="shopManage_main">
            <div class="search_top" style="text-align: center;">
                <Space size="large">
                    <Space>
                        <!-- <strong>分类</strong> -->
                        <Input v-model="search.keywords" placeholder="请输入名称关键字" size="small" clearable
                            style="width: 200px;" />
                    </Space>
                    <Space>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            getServiceCategoryListApi(data)
                .then(res => {
                    this.data = res
                    this.loading = false
                    // console.log(res);
