<template>
    <div class='organClassify'>
        ...
        <div class="i-layout-page-header">
            <PageHeader title="关爱服务管理" content="机构分类管理" hidden-breadcrumb />
        </div>
        <div class="shopManage_main">
            <div class="search_top" style="text-align: center;">
                <Space size="large">
                    <Space>
                        <!-- <strong>分类</strong> -->
                        <Input v-model="search.keywords" placeholder="请输入分类关键字" size="small" clearable
                            style="width: 200px;" />
                    </Space>
                    <Space>
                        <Button type="primary" size="small" @click="getList()"> 查询</Button>
                        <Button size="small" @click="search = {}; getList()">重置</Button>
                    </Space>
                </Space>
            </div>
            <div style="margin-bottom: 15px;">
                <Space size="large">
                    <Space>
                        <Icon type="md-list" />
                        <strong style="font-size: 16px;"> 机构分类列表</strong>
                    </Space>
                    <Button size="small" type="primary" @click="detailsFn(0)">添加</Button>
                </Space>
            </div>
            <Table border :columns="columns" :data="data" :loading="loading">
                ...
                <template #actionSlot="{ row }">
                    <Button type="primary" size="small" style="margin-right: 10px;"
                        @click=" detailsFn(row.id)">编辑</Button>
